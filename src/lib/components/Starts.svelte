<script>
    ...
    import { Color, DoubleSide, MeshBasicMaterial, PlaneGeometry, Vector3 } from 'three';
    ...
    function resetStar(star) {
        if (r(0, 1) > 0.8) {
            ...
            star.pos = new Vector3(r(-10, -45), r(-10.5, 1.5), r(30, -45));
            star.len = r(2.5, 20);
        }
        
        star.speed = r(19.5, 42);
        star.color = new Color(colors[Math.floor(Math.random() * colors.length)]).convertSRGBToLinear().multiplyScalar(1.3);
        return star;
    }
